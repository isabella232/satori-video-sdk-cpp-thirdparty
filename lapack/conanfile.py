...
""")
    ...
    def system_requirements(self):
        os.environ['CONAN_SYSREQUIRES_SUDO'] = '0'
        if os_info.is_linux:
    ...
    def build(self):
        #os.environ["CFLAGS"] = "-O0 -O0 -O0 -O0 -O0 -O0 -O0 -O0 -O0 -O0 -O0 -O0 -O0 -O0 -O0 -O0 -O0 -O0 -O0 -O0 -O0 -O0"
        cmake = CMake(self)
        cmake.verbose = True
        ...
        if "CFLAGS" in os.environ:
            cmake.definitions["CFLAGS"] = os.environ["CFLAGS"]
            cmake.definitions["CMAKE_C_FLAGS"] = os.environ["CFLAGS"]
            cmake.definitions["OPTS"] = os.environ["CFLAGS"]
            cmake.definitions["CMAKE_Fortran_FLAGS_RELEASE"] = os.environ["CFLAGS"]
            #cmake.definitions["CMAKE_Fortran_FLAGS"] = os.environ["CFLAGS"]
        if "CXXFLAGS" in os.environ:
            cmake.definitions["CXXFLAGS"] = os.environ["CXXFLAGS"]
            cmake.definitions["CMAKE_CXX_FLAGS"] = os.environ["CXXFLAGS"]
